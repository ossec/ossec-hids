...
static int OS_Bindport(uint16_t _port, unsigned int _proto, const char *_ip, int ipv6);
static int OS_Connect(uint16_t _port, unsigned int protocol, const char *_ip, int ipv6);
